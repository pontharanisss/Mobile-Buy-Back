          ...
          <CardBody>
            ...
            <Form className='auth-login-form mt-2'  >
              <div className='mb-1'>
                ...
                <Input type='email' id='login-email' placeholder='john' 
                autoFocus value={username} onChange={(e) => setUsername(e.target.value)}/>
              {errors && errors.username &&   <FormFeedback className='d-block'>Please Enter username</FormFeedback>}
              </div>
              <div className='mb-1'>
                ...
                id='login-password' value={passworddata} onChange={(e) => setPassworddata(e.target.value)}/>
